...
// ---- Deterministische Tagesliste (ohne KI) ----
// Liefert pro Kalendertag immer dieselbe, aber täglich neue Auswahl –
// perfekt für SSR: kein Fetch, kein Cache, sofort im HTML.
